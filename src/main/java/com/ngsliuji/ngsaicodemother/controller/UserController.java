package com.ngsliuji.ngsaicodemother.controller;
...
import com.ngsliuji.ngsaicodemother.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest) {
        ...
        String encryptPassword = userService.getEncryptePassword(DEFAULT_PASSWORD);
